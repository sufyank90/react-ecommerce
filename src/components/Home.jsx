...
function Home() {
  return (
    <>
      ...
      <div className="flex">
        <div className="w-1/6 mt-10">
          <div className="bg-gray-800  rounded-3xl p-2 mr-4">
            <div className="text-white">
              <a href="#link1" className="flex items-center border-2 bg-white text-1xl rounded-full text-teal-400 p-5 mb-2">
        ...
        <div className="w-5/6 mt-11 bg-black rounded-3xl relative overflow-hidden" style={{ height: '385px' }}>
          ...
          <div className="absolute inset-0 flex flex-col justify-center items-center text-white p-4">
            <h1 className="text-4xl font-bold mb-4">Mega Summer Sale</h1>
            <h1 className="text-4xl font-bold mb-4">Up to 50% Off Everything!</h1>
      ...
      <section class="bg-gray-100 dark:bg-gray-900 shadow-xl mt-5 rounded-3xl">
